...
| **Citation Check** — [`download`](dist/dingduff_citation-check_v2.5.7.skill) | v2.5.7 | After you draft a memo (Markdown, Word, or Google Docs), verifies every citation against your stored sources plus anything else you supply, quality-checks each highlighted passage for substance, then opens an interactive attorney review panel and records your verdicts. |
